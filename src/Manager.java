...
public class Manager{
	...
	public Manager ( Frame1 frame1, Frame2 frame2, Frame3 frame3, Frame4 frame4 ) throws IOException{
		...
		asel = new Acid( new BufferedReader(new InputStreamReader( getClass().getResourceAsStream("List_of_Weak_Acid.txt"))).readLine() );
		bsel = new Base( new BufferedReader(new InputStreamReader( getClass().getResourceAsStream("List_of_Weak_Base.txt"))).readLine() );
		KValue = asel.get_ka();
